...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  const nome = starWarsCharacters[i].name;
  if (gender === "female") {
...
console.log(" Eyecolor sarà: ==>", eyeColor);
/* aggiungere.push */
/* ESERCIZIO 6
...
/* --EXTRA-- ESERCIZIO 9
  ...
  */
console.log("prima parte", charactersNames);

for (let index = 0; index < femaleCharacters.length; index++) {
  const fem = femaleCharacters[index];
  for (let i = 0; i < charactersNames.length; i++) {
    const character = charactersNames[i];
    if (fem === character) {
      charactersNames.splice(i, 1); // toglie un elemnto a ciclo che corrisponde a fem
    }
  }
}
console.log(charactersNames);
...
const characterRandom = starWarsCharacters[indexRandom];

console.log("ho  trovato il character :", characterRandom);

if (characterRandom.gender === "female") {
  console.log(
    "lei è :",
    characterRandom.name,
    "e la sua pelle è",
    characterRandom.skin_color,
    "e il suo peso è ",
    characterRandom.mass,
    "il colore dei suoi capelli è",
    characterRandom.hair_color,
    "e il suo genere è ",
    characterRandom.gender
  );
} else {
  console.log(
    "lui è :",
